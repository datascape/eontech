...
// { num: 7, code: 'GUA', category: 'headgear', name: 'Header Band', src: "/virtual-reality/img/eon-tech-header-band.jpg", description: '. ', price: 110, cal: 10 },
// { num: 8, code: 'GUA', category: 'accessories', name: 'Flyability Drone', src: "/virtual-reality/img/flyability.png", description: '. ', price: 7500, cal: 10 }

function store() {
    this.products = [
          { num: 1, code: 'headgear', category: 'headgear', name: 'Pro Headgear', src: "/virtual-reality/img/eon-tech-helmet-pro.png", description: '. ', price: 180, cal: 10 },
          { num: 2, code: 'body-armor', category: 'armor', name: 'Body Armor', src: "/virtual-reality/img/eon-tech-chest-plate.png", description: '. ', price: 150, cal: 10 },
          { num: 3, code: 'leg-protection', category: 'armor', name: 'Leg Guards', src: "/virtual-reality/img/eon-tech-leg-guard.png", description: '. ', price: 130, cal: 10 },
          { num: 4, code: 'BAN', category: 'accessories', name: 'Neck Protector', src: "/virtual-reality/img/eon-tech-neck-support.jpg", description: '. ', price: 100, cal: 10 },
          { num: 5, code: 'CTP', category: 'headgear', name: 'Basic Headgear', src: "../img/eon-tech-helmet.png", description: '. ', price: 140, cal: 10 },
          { num: 6, code: 'GRP', category: 'accessories', name: 'Cord Suspension Kit', src: "/virtual-reality/img/eon-tech-cord-suspension.jpg", description: '. ', price: 40, cal: 10 }];
}
